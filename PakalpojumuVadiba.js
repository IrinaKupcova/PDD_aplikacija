/**
 * Pakalpojumu vadība — uzdevumi, posmi, apakšposmi, Gantt, Lists reģistri.
...
<script>window.addEventListener("load",function(){setTimeout(function(){window.print()},300)})</script>
  ...
  function ensureStyles() {
    if (typeof document === "undefined" || document.getElementById("pdd-pkv-styles-v9")) return;
    const el = document.createElement("style");
    el.id = "pdd-pkv-styles-v9";
    el.textContent = `
      .pv-root {
        --pv-bg: #e8f8f3;
        --pv-surface: #ffffff;
