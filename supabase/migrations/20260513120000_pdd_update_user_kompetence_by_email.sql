-- Jebkurš zināms PDD lietotājs (pēc e-pasta public.users) drīkst atjaunot users."Kompetence".
-- Tas nepieciešams, jo RLS (pdd_rls_users_admin_crud) parastajam lietotājam neļauj tiešu UPDATE uz public.users.
...
-- Atkārtoti tas pats nosacījums kā Aizvieto „open” variants (auth.uid vs users.id).
